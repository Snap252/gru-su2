...
| `investigator` | Code analysis and investigation |
...
| `/macro/fix-bugs` | Autonomously fix bugs |
| `/macro/implement-feature` | Implement features from an epic |
| `/macro/plan-epic` | Create an epic from specifications |
...
# Update bundled tools (Claude Code)
streb update
...
/headless/code-quality ./internals    # Code quality
```

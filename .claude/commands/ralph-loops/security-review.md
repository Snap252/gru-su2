...
./.claude/scripts/ralph/security-review.sh ./internals

# API-focused review
./.claude/scripts/ralph/security-review.sh ./internals --scope api

# PCI compliance review
./.claude/scripts/ralph/security-review.sh ./internals --compliance pci

# Combined options
./.claude/scripts/ralph/security-review.sh ./internals --scope auth --compliance soc2 -n 50
```

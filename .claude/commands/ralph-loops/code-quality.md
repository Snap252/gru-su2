...
```bash
# Full quality review
./.claude/scripts/ralph/code-quality.sh ./internals

# Complexity-focused review
./.claude/scripts/ralph/code-quality.sh ./internals --scope complexity

# With iteration limit
./.claude/scripts/ralph/code-quality.sh ./internals --scope performance -n 30
```
